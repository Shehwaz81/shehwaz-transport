        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -right-6 bg-orange-500 text-white p-6 rounded-2xl shadow-xl hidden md:block"
            >
              <p className="text-3xl font-bold">100%</p>
              <p className="text-sm font-medium text-orange-100">Client Satisfaction</p>
            </motion.div>
          </motion.div>
            ...
            <div>
              <div className="inline-block px-4 py-1.5 rounded-full border border-orange-500/30 bg-orange-500/10 mb-4">
                <span className="text-sm font-bold text-orange-500 tracking-wide uppercase">
                  The Shehwaz Transport Standard
                </span>
              </div>
